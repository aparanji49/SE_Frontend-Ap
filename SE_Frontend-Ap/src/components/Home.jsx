                    ...
                    <div className="col cards ">
                        <div className="card box-shadow">
                            ...
                            <div className="card-body">
                                <Link to="/predefinedHostForm/birthday" className="card-link">Birthday</Link>
                            </div>
                        </div>
                    </div>
                    <div className="col cards">
                        <div className="card box-shadow">
                            ...
                            <div className="card-body">
                                <Link to="/predefinedHostForm/art-exhibition" className="card-link">Art Exhibition</Link>
                            </div>
                        </div>
                    </div>
                    <div className="col cards">
                        <div className="card box-shadow">
                            ...
                            <div className="card-body">
                                <Link to="/predefinedHostForm/baby-shower" className="card-link">Baby Shower</Link>
                            </div>
                        </div></div><div className="col cards">
                        <div className="card box-shadow">
                            <img src={wedimg} className="card-img-top cardimage" alt="..." />
                            <div className="card-body">
                                <Link to="/predefinedHostForm/wedding-anniversary" className="card-link">Wedding Anniversary</Link>
                            </div>
                        </div></div><div className="col cards">
                        <div className="card box-shadow">
                            <img src={semimg} className="card-img-top cardimage" alt="..." />
                            <div className="card-body">
                                <Link to="/predefinedHostForm/workshop" className="card-link">Seminar/Workshop</Link>
                            </div>
                        </div></div><div className="col cards">
                        <div className="card box-shadow">
